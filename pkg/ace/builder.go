...
// QueryRow
func (s *orm) QueryRow(ctx context.Context) (*sql.Row, error) {
	defer s.Free()
...
func (s *orm) Get(ctx context.Context, dest any) error {
	defer s.Free()
...
func (s *orm) Gets(ctx context.Context, dest any) error {
	defer s.Free()
...
func (s *orm) Map(ctx context.Context) (map[string]any, error) {
	defer s.Free()
...
func (s *orm) Maps(ctx context.Context) ([]map[string]any, error) {
	defer s.Free()
...
func (s *orm) Slice(ctx context.Context) ([]any, error) {
	defer s.Free()
...
func (s *orm) Slices(ctx context.Context) ([][]any, error) {
	defer s.Free()
...
// Count
func (s *orm) Count(ctx context.Context, cond ...dialect.Condition) (int64, error) {
	defer s.Free()
...
// Sum
func (s *orm) Sum(ctx context.Context, cols []dialect.Field, cond ...dialect.Condition) (map[string]any, error) {
	defer s.Free()
...
func (s *orm) Select(ctx context.Context, sqlStr string, args ...any) (*sql.Rows, error) {
	defer s.Free()
...
func (se *orm) SelectMap(ctx context.Context, sqlStr string, args ...any) (map[string]any, error) {
...
func (se *orm) SelectSlice(ctx context.Context, sqlStr string, args ...any) ([]any, error) {
	rows, err := se.Select(ctx, sqlStr, args...)
	if err != nil {
		return nil, err
	}
...
func (se *orm) SelectModel(ctx context.Context, dest any, sqlStr string, args ...any) error {
	rows, err := se.Select(ctx, sqlStr, args...)
	if err != nil {
		return err
	}
