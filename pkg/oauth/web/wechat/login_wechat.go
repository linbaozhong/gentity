...
func (w *wx) Login(ctx context.Context, code, state string) (*web.SystemOauthTokenRsp, error) {
	...
	var result web.SystemOauthTokenRsp
	if err := json.Unmarshal(body, &result); err != nil {
		return nil, err
	}
	return &web.SystemOauthTokenRsp{}, nil
}
