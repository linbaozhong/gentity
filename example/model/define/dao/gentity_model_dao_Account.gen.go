...
//	// SelectAll 读取所有数据
//	SelectAll(ctx context.Context, s ace.SelectBuilder) ([]db.Account, bool, error)
...
func Account(exec ...ace.Executer) *daoAccount {
	_obj := &daoAccount{}
...
// SelectAll 查询所有
func (p *daoAccount) SelectAll(ctx context.Context, s ace.SelectBuilder) ([]db.Account, bool, error) {
