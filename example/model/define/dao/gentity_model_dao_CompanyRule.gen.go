...
type company_ruleer interface {
	...
	// SelectAll 读取所有数据
	SelectAll(ctx context.Context, s ace.ReadBuilder) ([]db.CompanyRule, bool, error)
...
// R Read company_rule
func (p *daoCompanyRule) R() ace.ReadBuilder {
...
// SelectAll 查询所有
func (p *daoCompanyRule) SelectAll(ctx context.Context, s ace.ReadBuilder) ([]db.CompanyRule, bool, error) {
