...
// UpdateById
func (p *daoUser) UpdateById(ctx context.Context, id uint64, sets ...dialect.Setter) (bool, error) {
	return p.Update(ctx,
		sets,
...
// DeleteById
func (p *daoUser) DeleteById(ctx context.Context, id uint64) (bool, error) {
	return p.Delete(ctx,
		tbluser.PrimaryKey.Eq(id),
	)
}
...
func (p *daoUser) GetByID(ctx context.Context, id uint64, cols ...dialect.Field) (*db.User, bool, error) {
