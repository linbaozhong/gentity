...
func (p *CompanyDocument) UnmarshalJSON(data []byte) error {
	...
	_result.ForEach(func(key, value gjson.Result) bool {
		...
		case "template_id":
			e = types.Unmarshal(value, &p.TemplateId, types.Money(value.Uint()))
		case "title":
			e = types.Unmarshal(value, &p.Title, types.String(value.Str))
		case "classify":
			e = types.Unmarshal(value, &p.Classify, types.Int8(value.Int()))
		case "genre":
			e = types.Unmarshal(value, &p.Genre, types.Int8(value.Int()))
		case "handle_genre":
			e = types.Unmarshal(value, &p.HandleGenre, types.Int8(value.Int()))
		case "job":
			e = types.Unmarshal(value, &p.Job, types.String(value.Str))
		case "variable_mode":
			e = types.Unmarshal(value, &p.VariableMode, types.Int32(value.Int()))
		case "is_default":
			e = types.Unmarshal(value, &p.IsDefault, types.Int8(value.Int()))
		case "can_default":
			e = types.Unmarshal(value, &p.CanDefault, types.Int8(value.Int()))
		case "modifier":
			e = types.Unmarshal(value, &p.Modifier, types.Money(value.Uint()))
		case "state":
