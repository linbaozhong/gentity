...
func (p *CompanyMan) UnmarshalJSON(data []byte) error {
	...
	_result.ForEach(func(key, value gjson.Result) bool {
		...
		case "account_id":
			e = types.Unmarshal(value, &p.AccountId, types.BigInt(value.Uint()))
		case "company_id":
			e = types.Unmarshal(value, &p.CompanyId, types.BigInt(value.Uint()))
		case "real_name":
			e = types.Unmarshal(value, &p.RealName, types.String(value.Str))
		case "email":
			e = types.Unmarshal(value, &p.Email, types.String(value.Str))
		case "roles":
			e = types.Unmarshal(value, &p.Roles, types.String(value.Str))
		case "state":
...
func (p *CompanyMan) Scan(rows *sql.Rows, args ...dialect.Field) ([]CompanyMan, bool, error) {
	...
	if len(company_mans) == 0 {
		return nil, false, sql.ErrNoRows
	}
	return company_mans, true, nil
}
