...
func (p *CompanyStamp) UnmarshalJSON(data []byte) error {
	...
	_result.ForEach(func(key, value gjson.Result) bool {
		...
		switch key.Str {
		case "id":
			e = types.Unmarshal(value, &p.Id, types.Money(value.Uint()))
		case "company_id":
			e = types.Unmarshal(value, &p.CompanyId, types.Money(value.Uint()))
		case "url":
		...
		case "creator_name":
			e = types.Unmarshal(value, &p.CreatorName, types.String(value.Str))
		case "department":
			e = types.Unmarshal(value, &p.Department, types.String(value.Str))
		case "position":
			e = types.Unmarshal(value, &p.Position, types.String(value.Str))
		case "state":
