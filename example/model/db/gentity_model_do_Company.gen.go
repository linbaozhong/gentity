...
func (p *Company) UnmarshalJSON(data []byte) error {
	...
	_result.ForEach(func(key, value gjson.Result) bool {
		...
		case "long_name":
			e = types.Unmarshal(value, &p.LongName, types.String(value.Str))
		case "short_name":
			e = types.Unmarshal(value, &p.ShortName, types.String(value.Str))
		case "address":
			e = types.Unmarshal(value, &p.Address, types.String(value.Str))
		case "email":
			e = types.Unmarshal(value, &p.Email, types.String(value.Str))
		case "contact_name":
			e = types.Unmarshal(value, &p.ContactName, types.String(value.Str))
		case "contact_telephone":
			e = types.Unmarshal(value, &p.ContactTelephone, types.String(value.Str))
		case "contact_mobile":
			e = types.Unmarshal(value, &p.ContactMobile, types.String(value.Str))
		case "contact_email":
			e = types.Unmarshal(value, &p.ContactEmail, types.String(value.Str))
		case "legal_name":
			e = types.Unmarshal(value, &p.LegalName, types.String(value.Str))
		case "creator":
